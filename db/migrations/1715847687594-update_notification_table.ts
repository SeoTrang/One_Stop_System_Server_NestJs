...
export class UpdateNotificationTable1715847687594 implements MigrationInterface {
    name = 'UpdateNotificationTable1715847687594'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`notifications\` ADD \`is_for_all\` tinyint NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`notification_receiver\` DROP COLUMN \`receiver_identifier\``);
        await queryRunner.query(`ALTER TABLE \`notification_receiver\` ADD \`receiver_identifier\` int NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`notification_receiver\` DROP COLUMN \`receiver_identifier\``);
        await queryRunner.query(`ALTER TABLE \`notification_receiver\` ADD \`receiver_identifier\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`notification_receiver\` ADD CONSTRAINT \`FK_3059a57127fb6b14dc2c2d195b9\` FOREIGN KEY (\`notificationId\`) REFERENCES \`notifications\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD CONSTRAINT \`FK_848c0779e2423d52fd964bbb793\` FOREIGN KEY (\`facultyId\`) REFERENCES \`faculties\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`notifications\` DROP COLUMN \`is_for_all\``);
    }
