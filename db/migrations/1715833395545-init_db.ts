...
export class InitDb1715833395545 implements MigrationInterface {
    name = 'InitDb1715833395545'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`attribute_value\` (\`id\` int NOT NULL AUTO_INCREMENT, \`value\` varchar(255) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`documentId\` int NULL, \`attributeFormServiceId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`notification_receiver\` (\`id\` int NOT NULL AUTO_INCREMENT, \`is_read\` tinyint NOT NULL DEFAULT 0, \`type_user\` varchar(255) NOT NULL, \`receiver_identifier\` varchar(255) NOT NULL, \`notificationId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`notifications\` (\`id\` int NOT NULL AUTO_INCREMENT, \`entity_type\` varchar(255) NOT NULL, \`entity_id\` int NOT NULL, \`actor_identifier\` int NOT NULL, \`notificationTypeId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`notification_type\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE \`notification_receiver\``);
