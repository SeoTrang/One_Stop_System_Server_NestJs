...
export class UpdateTimeFieldAllTable1709084166882 implements MigrationInterface {
    name = 'UpdateTimeFieldAllTable1709084166882'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`attribute_form_enum\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`attribute_form_enum\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`post_reaction\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`post_reaction\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`procedural_step\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`procedural_step\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`document\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`document\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`attribute_value\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`attribute_value\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`attribute_form_service\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`attribute_form_service\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`service\` ADD \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`service\` ADD \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`attribute_form_service\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`attribute_form_service\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`attribute_value\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`attribute_value\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`document\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`document\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`procedural_step\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`procedural_step\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`post_reaction\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`post_reaction\` DROP COLUMN \`created_at\``);
        await queryRunner.query(`ALTER TABLE \`attribute_form_enum\` DROP COLUMN \`updated_at\``);
        await queryRunner.query(`ALTER TABLE \`attribute_form_enum\` DROP COLUMN \`created_at\``);
    }
