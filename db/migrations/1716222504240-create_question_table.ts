...
export class CreateQuestionTable1716222504240 implements MigrationInterface {
    name = 'CreateQuestionTable1716222504240'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`notification_receiver\` DROP FOREIGN KEY \`FK_3059a57127fb6b14dc2c2d195b9\``);
        await queryRunner.query(`CREATE TABLE \`question_media_content\` (\`id\` int NOT NULL AUTO_INCREMENT, \`url\` varchar(255) NOT NULL, \`type\` enum ('img', 'file') NOT NULL, \`questionId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`question_seen\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type_user\` varchar(255) NOT NULL, \`user_id\` int NOT NULL, \`questionId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`question\` (\`id\` int NOT NULL AUTO_INCREMENT, \`content\` text NOT NULL, \`type_user\` varchar(255) NOT NULL, \`user_id\` int NOT NULL, \`departmentId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`department\` ADD \`questionsId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`department\` ADD CONSTRAINT \`FK_5e04d04210d54297ce704a7edad\` FOREIGN KEY (\`questionsId\`) REFERENCES \`question\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`department\` DROP FOREIGN KEY \`FK_5e04d04210d54297ce704a7edad\``);
        await queryRunner.query(`ALTER TABLE \`post\` DROP FOREIGN KEY \`FK_c91b8eb1dc23fd5dae700265ed2\``);
        await queryRunner.query(`ALTER TABLE \`post_reaction\` DROP FOREIGN KEY \`FK_5e7b98f3cea583c73a0bbbe0de1\``);
        await queryRunner.query(`ALTER TABLE \`post_media_content\` DROP FOREIGN KEY \`FK_aaea8f6b6b6fe037df5846211fa\``);
        await queryRunner.query(`ALTER TABLE \`post_comment\` DROP FOREIGN KEY \`FK_c7fb3b0d1192f17f7649062f672\``);
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD CONSTRAINT \`FK_848c0779e2423d52fd964bbb793\` FOREIGN KEY (\`facultyId\`) REFERENCES \`faculties\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`department\` DROP COLUMN \`questionsId\``);
        await queryRunner.query(`DROP TABLE \`question\``);
        await queryRunner.query(`DROP TABLE \`question_seen\``);
        await queryRunner.query(`DROP TABLE \`question_media_content\``);
        await queryRunner.query(`ALTER TABLE \`notification_receiver\` ADD CONSTRAINT \`FK_3059a57127fb6b14dc2c2d195b9\` FOREIGN KEY (\`notificationId\`) REFERENCES \`notifications\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
