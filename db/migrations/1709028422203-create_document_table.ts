...
export class CreateDocumentTable1709028422203 implements MigrationInterface {
    name = 'CreateDocumentTable1709028422203'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`document\` (\`id\` int NOT NULL AUTO_INCREMENT, \`status\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`address\` text NULL, \`type_user\` varchar(255) NOT NULL, \`departmentId\` int NULL, \`serviceId\` int NULL, \`proceduralStepId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
