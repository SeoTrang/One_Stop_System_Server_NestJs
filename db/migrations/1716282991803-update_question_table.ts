...
export class UpdateQuestionTable1716282991803 implements MigrationInterface {
    name = 'UpdateQuestionTable1716282991803'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`question\` ADD \`type_question\` enum ('Thắc mắc', 'Câu hỏi') NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`question\` CHANGE \`conversationId\` \`conversationId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`conversation\` CHANGE \`departmentId\` \`departmentId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`conversation\` CHANGE \`departmentId\` \`departmentId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`conversation\` ADD CONSTRAINT \`FK_c308b1cd542522bb66430fa860a\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`conversation\` ADD CONSTRAINT \`FK_13726cdc9975958a10897a3e62c\` FOREIGN KEY (\`departmentId\`) REFERENCES \`department\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`question\` CHANGE \`conversationId\` \`conversationId\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`question\` DROP COLUMN \`type_question\``);
    }
