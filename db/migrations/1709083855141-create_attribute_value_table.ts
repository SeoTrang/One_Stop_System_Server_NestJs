...
export class CreateAttributeValueTable1709083855141 implements MigrationInterface {
    name = 'CreateAttributeValueTable1709083855141'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`attribute_value\` (\`id\` int NOT NULL AUTO_INCREMENT, \`value\` varchar(255) NOT NULL, \`documentId\` int NULL, \`attributeFormServiceId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
