...
export class CreateProceduralStepTable1709023187541 implements MigrationInterface {
    name = 'CreateProceduralStepTable1709023187541'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`procedural_step\` (\`id\` int NOT NULL AUTO_INCREMENT, \`step\` int NOT NULL, \`departmentId\` int NULL, \`serviceId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
